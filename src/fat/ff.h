...
typedef struct _FATFS_ {
	...
	UCHAR	drive;		/* Physical drive number */
	UCHAR	csize;		/* Number of sectors per cluster */
	UCHAR	n_fats;		/* Number of FAT copies */
	...
	UCHAR	win[_MAX_SS];/* Disk access window for Directory/FAT */
} FATFS;
...
typedef struct _FIL_ {
	...
	UCHAR	csect;		/* Sector address in the cluster */
...
#endif
#if !_FS_TINY
	UCHAR	buf[_MAX_SS];/* File R/W buffer */
#endif
} FIL;
...
FRESULT f_open (FIL*, const XCHAR*, UCHAR);			/* Open or create a file */
...
FRESULT f_chmod (const XCHAR*, UCHAR, UCHAR);			/* Change attriburte of the file/dir */
...
FRESULT f_mkfs (UCHAR, UCHAR, WORD);					/* Create a file system on the drive */
...
/* Sync functions */
#if _FS_REENTRANT
BOOL ff_cre_syncobj(UCHAR, _SYNC_t*);
